...
{
    public class WhenRegionIsSupplied : DynamoDBClientFactorySpecification<AmazonDynamoDBClient>
    {
        public WhenRegionIsSupplied(DynamoDBConfigurationFixture configurationFixture, ITestOutputHelper testOutputHelper) : base(configurationFixture, testOutputHelper)
        {
        }
        ...
        protected override IServiceCollection BuildServices(IServiceCollection services)
        {
            services.AddDynamoDBOptions<WhenRegionIsSupplied>(o =>
            {
                ...
                o.Region = _configurationFixture.Configuration.GetValue<string>("AWS:DynamoDB:Region");
                o.ClientConfig = new()
                {
