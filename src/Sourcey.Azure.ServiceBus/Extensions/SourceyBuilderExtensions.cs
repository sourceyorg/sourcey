...
using Sourcey.Azure.ServiceBus;
using Sourcey.Azure.ServiceBus.Management;
using Sourcey.Azure.ServiceBus.Messages;
using Sourcey.Azure.ServiceBus.Queues;
using Sourcey.Azure.ServiceBus.Subscriptions;
...
namespace Sourcey.Extensions
{
    ...
    {
        public static ISourceyBuilder AddAzureServiceBus(this ISourceyBuilder builder, Action<ServiceBusOptions> optionsAction)
        {
            if (builder == null)
        ...
        public static ISourceyBuilder AddAzureServiceBusQueue(this ISourceyBuilder builder, Action<ServiceBusQueueOptions> optionsAction)
        {
            if (builder == null)
                throw new ArgumentNullException(nameof(builder));
